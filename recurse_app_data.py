# This contains poems from William Braithwaite's 1913 Anthology of Massachusetts Poets, assigned to variables. At the end is a dictionary classifying the poems by meter; I am not including mixed feet for simplicity's sake, but should work to account for them eventually.
...
RUTH LAMBERT JONES
"""
old_song = """WHEN I was but a young lad,
...
"""
old_lizette = """BED is the boon for me!
  ...
  """
motherhood = """MARY, the Christ long slain, passed silently.
...
song_of_the_wave = """This is the song of the wave! The mighty one!
...
frimaire = """DEAREST, we are like two flowers
...
AMY LOWELL
"""
bather = """THICK dappled by circles of sunshine and fluttering shade.
...
AMY LOWELL
  """
leprechauns_and_cluricauns = """OVER where the Irish hedges
...
"""
to_imagination = """O BEAUTEOUS boy a-dream, what visions
  sought
...
dragon = """
  ...
  Oho! Oho! Oho, ho, ho!
"""
green_golden_door = """GREEN golden door, swing in, swing in!
...
sword_of_arthur = """A CASTLE stands in Yorkshire
...
divine_forest = """IF there be leaves on the forest floor,
...
CHARLES R. MURPHY
"""
magic = """I RAN into the sunset light
...
"""
michael_pat = """OLD Michael Pat he said to me
...
"""
from_flesh = """EBB on with me across the sunset tide
...
in_memoriam ="""SOLDIER and singer of Erin,
...
evensong = """A SHEPHERD piping, herald of the Night
...
"""
prophet = """ALL day long he kept the sheep:—
...
"""
harvest_moon ="""OVER the twilight field,
...
horseman_springing = """"HORSEMAN, springing from the dark,
...
shipbuilders = """THE German people reared them
...
unfading_pictures = """HOW many are the scenes he limned,
...
nocturne = """"NIGHT of infinite power and infinite silence and space,
